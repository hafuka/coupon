...
<html lang="ja">
    ...
    <body class="outline formContents">
        ...
        <section>
        	...
        	<form method="post" action="/coupon/admin/adminBasic/regist" name="frm">
        ...
        <script src="/coupon/js/jquery-2.1.0.min.js.js"></script>
        <script src="/coupon/js/admin_basic.js"></script>
